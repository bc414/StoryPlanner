...
namespace WindowedStoryPlanner.ViewModels
{
    public partial class NoteTrackDefinitionViewModel : ObservableObject
    {
        ...
        {
            get => _model.FunctionKeyNumber;
            set => SetProperty(_model.FunctionKeyNumber, value, _model, (m, v) => m.FunctionKeyNumber = v);
        }
        ...
        public string FunctionKeyLabel => FunctionKeyNumber.HasValue ? $"F{FunctionKeyNumber}" : "—";
