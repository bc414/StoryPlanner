...
{
    /// <summary>
    /// Chain membership by study type, from artifacts.md § Study registry. A closed set
    ...
    public static string Build(string repoRoot, SkillDocument doc, bool forced = false)
    {
        ...
        sb.Append("Never hand-edited: `state` rewrites this file whole from the study registry, the question " +
        ...
        if (forced)
            sb.Append("> **UNVALIDATED** — written with `--force` while `validate` still fails. Not authoritative.\n\n");
    ...
    /// <summary>The referee's folder is <c>fanout/referee/</c> for every <c>referee-&lt;n&gt;</c> (artifacts.md § Study registry).</summary>
