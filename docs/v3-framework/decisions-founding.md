...
Closed 2026-09-07: the decisions from that day on are in `decisions.md`, under the schema
`schemas/decisions-schema.md`; this file is never written again, and what stands of it is
the skill's text.
