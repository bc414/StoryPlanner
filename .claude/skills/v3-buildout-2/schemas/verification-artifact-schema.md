...
`docs/v3-framework/<study>/verification.md`. Written once by verifying-a-corpus;
...
```markdown
# verification-of-fimfiction-stories-1
...
## Questions answered
<the questions this verification's items and predicates cover, one per line, each cited as
