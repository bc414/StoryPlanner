...
Never hand-edited: `render` rewrites this file whole from the study registry, the question lists, the hypothesis files, the study folders and the codebooks on disk. What is here, never what to do next; the pick is Brian's.
