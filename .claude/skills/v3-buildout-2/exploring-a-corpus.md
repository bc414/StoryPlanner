...
the directions stand. For a one-item batch: the corpus, or a stated narrowing of it, fits one
call.
...
with the index, and the questions in view from the frontmatter of the directions the
